...
[박영준님 TIL의 README.md](https://github.com/jun108059/til/blob/master/docs/README.md)와 같이 구성하니 메인 페이지에 적용되는 것을 확인했다.
vuepress에서 권장하는 구조로 변경하고, 현재 리포지토리에 맞게 코드를 수정했다.

먼저, `README.md`를 다음과 같은 방식으로 구성했다.
...
```
그 다음 `.vuepress > styles > index.styl` 내에 아래와 같이 css 코드를 추가했다. 이 때, 원하는 귀여운 폰트가 적용되도록 폰트를 import 받아와 전체 페이지에 적용했다.
...
그러면 아래와 같이 귀여운 폰트와 스타일이 적용된 것을 확인할 수 있다.

![](../.vuepress/public/images/git/002-02.png)

## 05. 플러그인 적용하기
### back-to-top
페이지 스크롤을 통해 아래로 내려갔을 때, 맨 위로 올려주는 버튼이 우측 하단에 생성되는 플러그인이다.
먼저, yarn을 통해 설치를 해준다.
```bash
yarn add -D @vuepress/plugin-back-to-top
```
그 다음 `config.js` 파일 내에 설정을 추가한다.
```js
module.exports = {
  // ...
...
```
### Last Updated
깃 기반으로 마지막 업데이트 날짜를 게시글 우측 하단에 표시하는 플러그인이다.
별도의 설치 없이 `config.js` 파일 내에 설정을 추가하면 된다.
```js
module.exports = {
  // ...
...
```
기본적으로 시간은 AM, PM을 사용하는 12시간 형식으로 되어 있는데, 24시간으로 변경하고 싶다면 아래와 같이 `config.js` 파일 내에 설정하면 된다.
```js
module.exports = {
  // ...
  plugins: [
...
- [https://v1.vuepress.vuejs.org/guide/getting-started.html#manual-installation](https://v1.vuepress.vuejs.org/guide/getting-started.html#manual-installation)
- [https://prove.netlify.app/vuepress_githubpages_travis/vuepress-%EB%A5%BC-%EC%82%AC%EC%9A%A9%ED%95%98%EC%97%AC-%EB%B8%94%EB%A1%9C%EA%B7%B8-%EB%B0%B0%ED%8F%AC%ED%95%98%EA%B8%B0/](https://prove.netlify.app/vuepress_githubpages_travis/vuepress-%EB%A5%BC-%EC%82%AC%EC%9A%A9%ED%95%98%EC%97%AC-%EB%B8%94%EB%A1%9C%EA%B7%B8-%EB%B0%B0%ED%8F%AC%ED%95%98%EA%B8%B0/)
- [https://rios.tistory.com/entry/React-npm-yarn-%EC%84%A4%EC%B9%98-%EC%98%A4%EB%A5%98-error-An-unexpected-error-occurred](https://rios.tistory.com/entry/React-npm-yarn-%EC%84%A4%EC%B9%98-%EC%98%A4%EB%A5%98-error-An-unexpected-error-occurred)
- [https://cnu-jinseop.tistory.com/147](https://cnu-jinseop.tistory.com/147)
- [https://kyounghwan01.github.io/blog/Vue/vuepress/vuepress-start/#%E1%84%89%E1%85%A5%E1%86%AF%E1%84%8E%E1%85%B5](https://kyounghwan01.github.io/blog/Vue/vuepress/vuepress-start/#%E1%84%89%E1%85%A5%E1%86%AF%E1%84%8E%E1%85%B5)
...
- [https://github.com/jun108059/til/blob/master/docs/.vuepress](https://github.com/jun108059/til/blob/master/docs/.vuepress)
- [https://github.com/milooy/TIL/blob/master/documents/.vuepress/components/Home.vue](https://github.com/milooy/TIL/blob/master/documents/.vuepress/components/Home.vue)
- [https://vuepress.vuejs.org/plugin/official/plugin-back-to-top.html](https://vuepress.vuejs.org/plugin/official/plugin-back-to-top.html)